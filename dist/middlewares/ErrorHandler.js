    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            if (error.type === "error_user_notFound") {
                return [2 /*return*/, res.status(404).send({ message: error.message })];
            }
            if (error.type === "error_wrongLogin") {
                return [2 /*return*/, res.status(401).send({ message: error.message })];
            }
            if (error.type === "error_user_inUse") {
                return [2 /*return*/, res.status(422).send({ message: error.message })];
            }
